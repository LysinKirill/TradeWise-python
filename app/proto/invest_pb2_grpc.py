...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in invest_pb2_grpc.py depends on'
...
class InvestServiceStub(object):
...
def add_InvestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSupportedInstruments': grpc.unary_unary_rpc_method_handler(
            ...
            'GetInstrumentStat': grpc.unary_unary_rpc_method_handler(
...
class InvestService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def GetSupportedInstruments(request,
            target,
            options=(),
