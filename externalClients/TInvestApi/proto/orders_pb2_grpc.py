...
from externalClients.TInvestApi.proto import orders_pb2 as orders__pb2
...
class OrdersServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PostOrderAsync = channel.unary_unary(
                ...
                request_serializer=orders__pb2.PostOrderAsyncRequest.SerializeToString,
                response_deserializer=orders__pb2.PostOrderAsyncResponse.FromString,
                _registered_method=True)
...
def add_OrdersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PostOrderAsync': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=orders__pb2.PostOrderAsyncRequest.FromString,
                    response_serializer=orders__pb2.PostOrderAsyncResponse.SerializeToString,
            ),
...
class OrdersService(object):
    ...
    def PostOrderAsync(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.OrdersService/PostOrderAsync',
            orders__pb2.PostOrderAsyncRequest.SerializeToString,
            orders__pb2.PostOrderAsyncResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
